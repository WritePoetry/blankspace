	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			...
			<figure class="wp-block-image size-full">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/404-image.png" alt="<?php echo esc_attr_x( 'Small totara tree on ridge above Long Point', 'image description', 'blankspace' ); ?>" style="object-fit:cover"/>
			</figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
